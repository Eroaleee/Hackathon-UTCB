...
export const defaultMapLayers: MapLayer[] = [
  ...
  { id: "infrastructura", label: "Infrastructură ciclabilă", color: "#22c55e", icon: "infra", visible: true },
  { id: "proiecte", label: "Proiecte în desfășurare", color: "#3b82f6", icon: "project", visible: true },
